import { PolicyHandler, PolicyHandlerCallback } from "@backend/app/permission/permission.types";
import { CanActivate, ExecutionContext, ForbiddenException, Injectable, UnauthorizedException } from "@nestjs/common";
import { Reflector } from "@nestjs/core";
import { CHECK_POLICIES_KEY } from "@backend/decorators/check-policies.decorator";
import { AppAbility, CaslAbilityFactory } from "@backend/app/permission/casl-ability.factory";
