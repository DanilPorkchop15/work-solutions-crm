...
import { DocumentLog, DocumentLogsTableModule, DocumentLogView, useDocumentLogsTableModule } from "../../../../entities/document";
...
export const DocumentLogsTable: React.FC<DocumentLogsTableProps> = observer(function DocumentLogsTable({
