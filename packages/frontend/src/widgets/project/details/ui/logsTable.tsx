...
import { ProjectLog, ProjectLogsTableModule, ProjectLogView, useProjectLogsTableModule } from "../../../../entities/project";
...
export const ProjectLogsTable: React.FC<ProjectLogsTableProps> = observer(function ProjectLogsTable({
