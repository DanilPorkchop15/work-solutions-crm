...
import { CustomerLog, CustomerLogsTableModule, CustomerLogView, useCustomerLogsTableModule } from "../../../../entities/customer";
...
export const CustomerLogsTable: React.FC<CustomerLogsTableProps> = observer(function CustomerLogsTable({
