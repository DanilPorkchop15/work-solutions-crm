...
import type { FilterParams, PaginationParams, PathParams, SortingParams } from "./additionalRequestParams";
...
> {
  ...
  public get urlParams(): P {
    return this.pathParams.snapshot();
  }
  ...
  public async load(): Promise<void> {
    const table = await this._getData(this.queryParams, this.urlParams);
  ...
  protected abstract _getData(additionalQueryParams: Pagination & F & Sorting<S>, urlParams?: P): Promise<TableDto<T>>;
